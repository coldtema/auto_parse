...
class TruckParser():
    ...
    def dump_data(self, data):
         for elem in data:
            ru_fuel_type = truck_korean_dict['FUEL_TYPES'].get(elem.get('FuelType', ''), None)
            ...
            if 'Record' in list(elem['Condition']): flag_record=True
            if 'Resume' in list(elem['Condition']): flag_resume=True
            eng_manufacturer = truck_korean_dict['MANUFACTURERS'].get(elem.get('Manufacturer', ''), None)
...
car_korean_dict = {
    ...
    'COLOR': {
        ...
        "녹색": ("green", "Зелёный"),
        "연두색": ("light_green", "Салатовый"),
        "은색투톤": ("silver_two_tone", "Серебристый двухцветный"),
        "갈대색": ("beige", "Бежевый"),
        "검정투톤": ("black_two_tone", "Чёрный двухцветный"),
        "갈색": ("brown", "Коричневый"),
        "담녹색": ("dark_green", "Тёмно-зелёный"),
        "흰색": ("white", "Белый"),
        "금색투톤": ("gold_two_tone", "Золотистый двухцветный"),
        "연금색": ("light_gold", "Светло-золотистый"),
        "청색": ("blue", "Синий"),
        "금색": ("gold", "Золотистый"),
        "은색": ("silver", "Серебристый"),
        "명은색": ("light_silver", "Светло-серебристый"),
        "분홍색": ("pink", "Розовый"),
        "검정색": ("black", "Чёрный"),
        "하늘색": ("sky_blue", "Голубой"),
        "쥐색": ("gray", "Серый"),
        "은하색": ("silver_gray", "Серебристо-серый"),
        "은회색": ("silver_gray", "Серебристо-серый"),
        "흰색투톤": ("white_two_tone", "Белый двухцветный"),
        "빨간색": ("red", "Красный"),
        "자주색": ("burgundy", "Бордовый"),
        "노란색": ("yellow", "Жёлтый"),
        "진주색": ("pearl", "Жемчужный"),
        "보라색": ("purple", "Фиолетовый"),
        "청옥색": ("turquoise", "Бирюзовый"),
        "갈색투톤": ("brown_two_tone", "Коричневый двухцветный"),
        "진주투톤": ("pearl_two_tone", "Жемчужный двухцветный"),
        "기타": ("other", "Другое")
    },
    'BODY_NAME': {
        '중형차': ("mid_size_sedan", "Среднеразмерный седан"),
        'RV': ("station_wagon", "Универсал"),
        '승합차': ("minibus", "Минивэн"),
        '대형차': ("full_size_sedan", "Полноразмерный седан"),
        '기타': ("other", "Другое"),
        '스포츠카': ("sports_car", "Спортивный автомобиль"),
        '준중형차': ("compact_sedan", "Компактный седан"),
        '경차': ("city_car", "Городской компакткар"),
        '화물차': ("pickup", "Пикап"),
        'SUV': ("suv", "Кроссовер / SUV"),
        '소형차': ("hatchback", "Хэтчбек")
    }
}
